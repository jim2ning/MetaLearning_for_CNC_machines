...
class LSTMVAE(nn.Module):
    def __init__(self, input_dim, hidden_dim, latent_dim, num_layers=2, dropout_rate=0.1):
    ...
    def encode(self, x):
        ...
        hidden = hidden[-1]  # 마지막 레이어의 hidden state만 사용
